...
return [
    'exports' => [
        ...
        'csv' => ['delimiter' => ',', 'enclosure' => '"', 'line_ending' => PHP_EOL, 'use_bom' => false, 'include_separator_line' => false, 'excel_compatibility' => false, 'output_encoding' => '', 'test_auto_filter_columns' => false],
        'properties' => ['creator' => 'Sistema Gestión Escolar', 'lastModifiedBy' => '', 'title' => '', 'description' => '', 'subject' => '', 'keywords' => '', 'category' => '', 'manager' => '', 'company' => ''],
    ],
    'imports' => [
        'read_only' => true,
        'ignore_empty' => false,
        'heading_row' => ['formatter' => 'slug'],
        'csv' => ['delimiter' => null, 'enclosure' => '"', 'escape_character' => '\\', 'contiguous' => false, 'input_encoding' => 'UTF-8'],
        'properties' => [],
        'force_resync_full' => null,
    ],
    'extension_detector' => [
    ...
    'cache' => ['driver' => 'memory', 'stores' => ['memory' => ['driver' => 'memory'], 'batch' => ['driver' => 'batch']]],
    'transactions' => ['handler' => 'db', 'db' => ['connection' => null]],
