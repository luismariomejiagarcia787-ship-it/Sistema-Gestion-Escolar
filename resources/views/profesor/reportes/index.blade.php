...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="card text-center"><div class="card-body">
            <div class="fs-2 fw-bold text-primary">{{ $cursos->count() }}</div>
            <div class="text-muted small">Cursos a cargo</div>
        </div></div>
    </div>
    <div class="col-md-4">
        <div class="card text-center"><div class="card-body">
            <div class="fs-2 fw-bold text-info">{{ $materias->count() }}</div>
            <div class="text-muted small">Materias a cargo</div>
        </div></div>
    </div>
    <div class="col-md-4">
        <div class="card text-center"><div class="card-body">
            <div class="fs-2 fw-bold nota-alta">{{ $cursos->sum('estudiantes_count') }}</div>
    ...
    <div class="col-md-6">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('profesor.reportes.academico') }}" class="btn btn-outline-primary btn-sm mb-3"><i class="bi bi-graph-up me-1"></i>Ver Reporte Académico</a>
                <hr>
                <p class="text-muted small mb-2">Exportar:</p>
                <a href="{{ route('profesor.reportes.pdf.calificaciones') }}" class="btn btn-danger btn-sm"><i class="bi bi-file-earmark-pdf me-1"></i>PDF Mis Calificaciones</a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('profesor.reportes.asistencia') }}" class="btn btn-outline-primary btn-sm"><i class="bi bi-bar-chart me-1"></i>Ver Reporte de Asistencia</a>
            </div>
        </div>
    </div>
</div>
