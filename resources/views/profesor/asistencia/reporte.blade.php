...
@section('breadcrumb')<li class="breadcrumb-item"><a href="{{ route('profesor.asistencia.index') }}">Asistencia</a></li><li class="breadcrumb-item active">Reporte</li>@endsection
@section('content')
