...
@section('breadcrumb')<li class="breadcrumb-item"><a href="{{ route('profesor.calificaciones.index') }}">Calificaciones</a></li><li class="breadcrumb-item active">Editar</li>@endsection
@section('content')
...
<form action="{{ route('profesor.calificaciones.update', $calificacion) }}" method="POST">
    @csrf @method('PUT')
    <div class="row g-3">
        ...
        <div class="col-12"><label class="form-label fw-semibold">Observación</label><textarea name="observacion" class="form-control" rows="2">{{ old('observacion',$calificacion->observacion) }}</textarea></div>
