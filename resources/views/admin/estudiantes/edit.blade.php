...
<form action="{{ route('admin.estudiantes.update', $estudiante) }}" method="POST" enctype="multipart/form-data">
    @csrf @method('PUT')
    <div class="row g-3">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $estudiante->user->name) }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Documento <span class="text-danger">*</span></label>
                            <input type="text" name="documento" class="form-control" value="{{ old('documento', $estudiante->documento) }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Correo Electrónico <span class="text-danger">*</span></label>
                            <input type="email" name="email" class="form-control" value="{{ old('email', $estudiante->user->email) }}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="fecha_nacimiento" class="form-control" value="{{ old('fecha_nacimiento', $estudiante->fecha_nacimiento?->format('Y-m-d')) }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="curso_id" class="form-select">
                                ...
                                @foreach($cursos as $c)
                                    <option value="{{ $c->id }}" {{ old('curso_id', $estudiante->curso_id) == $c->id ? 'selected' : '' }}>{{ $c->nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img id="foto-preview"
                        src="{{ $estudiante->foto ? asset('storage/'.$estudiante->foto) : asset('assets/img/default-avatar.svg') }}"
