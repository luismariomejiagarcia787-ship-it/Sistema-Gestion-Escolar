...
@section('breadcrumb')<li class="breadcrumb-item"><a href="{{ route('admin.reportes.index') }}">Reportes</a></li><li class="breadcrumb-item active">Académico</li>@endsection
@section('content')
<div class="d-flex align-items-center justify-content-between mb-4">
    <h4 class="fw-bold mb-0"><i class="bi bi-graph-up text-primary me-2"></i>Reporte Académico</h4>
    <div class="d-flex gap-2">
        <a href="{{ route('admin.reportes.pdf.calificaciones') }}" class="btn btn-danger btn-sm"><i class="bi bi-file-earmark-pdf me-1"></i>PDF</a>
        <a href="{{ route('admin.reportes.excel.calificaciones') }}" class="btn btn-success btn-sm"><i class="bi bi-file-earmark-excel me-1"></i>Excel</a>
    </div>
</div>
