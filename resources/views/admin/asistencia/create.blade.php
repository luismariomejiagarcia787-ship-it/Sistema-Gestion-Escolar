...
@section('breadcrumb')<li class="breadcrumb-item"><a href="{{ route('admin.asistencia.index') }}">Asistencia</a></li><li class="breadcrumb-item active">Registrar</li>@endsection
@section('content')
<div class="d-flex align-items-center justify-content-between mb-4">
    <h4 class="fw-bold mb-0"><i class="bi bi-calendar-plus text-primary me-2"></i>Registrar Asistencia</h4>
    <a href="{{ route('admin.asistencia.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i>Volver</a>
</div>
<div class="card"><div class="card-body">
<form action="{{ route('admin.asistencia.store') }}" method="POST" id="asistenciaForm">
    @csrf
    ...
    <div id="tablaAsistencia" class="d-none">
        ...
        <div class="d-flex justify-content-end gap-2 mt-3">
            <a href="{{ route('admin.asistencia.index') }}" class="btn btn-outline-secondary">Cancelar</a>
...
document.getElementById('cargarEstudiantes').addEventListener('click', function(){
    ...
    fetch('{{ route('admin.asistencia.estudiantes') }}?curso_id=' + cursoId)
        .then(r => r.json())
        .then(data => {
