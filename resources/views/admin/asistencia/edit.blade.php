...
@section('breadcrumb')<li class="breadcrumb-item"><a href="{{ route('admin.asistencia.index') }}">Asistencia</a></li><li class="breadcrumb-item active">Editar</li>@endsection
@section('content')
...
{{ $asistencia->estudiante?->user?->name ?? 'Sin estudiante asignado' }}
        <strong>Curso:</strong> {{ $asistencia->curso?->nombre ?? 'Sin curso asignado' }}
    </div>
