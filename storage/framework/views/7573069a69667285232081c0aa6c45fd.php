<?php $__env->startSection('title','Editar Calificación'); ?>
<?php $__env->startSection('breadcrumb'); ?><li class="breadcrumb-item"><a href="<?php echo e(route('admin.calificaciones.index')); ?>">Calificaciones</a></li><li class="breadcrumb-item active">Editar</li><?php $__env->stopSection(); ?>
...
<form action="<?php echo e(url('admin/calificaciones/'.$calificacion->id)); ?>" method="POST">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label fw-semibold">Profesor</label>
            <select name="profesor_id" class="form-select">
                ...
                <?php $__currentLoopData = $profesores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($p->id); ?>" <?php echo e(old('profesor_id',$calificacion->profesor_id)==$p->id?'selected':''); ?>><?php echo e($p->user->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <div class="col-12"><label class="form-label fw-semibold">Observación</label><textarea name="observacion" class="form-control" rows="3"><?php echo e(old('observacion',$calificacion->observacion)); ?></textarea></div>
        <div class="col-12 d-flex gap-2 justify-content-end">
            <a href="<?php echo e(route('admin.calificaciones.index')); ?>" class="btn btn-outline-secondary">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC Lenovo\Downloads\SistemaGestionEscolar (1)\SistemaGestionEscolar\resources\views/admin/calificaciones/edit.blade.php ENDPATH**/ ?>