...
<?php $__env->startSection('breadcrumb'); ?><li class="breadcrumb-item"><a href="<?php echo e(route('profesor.asistencia.index')); ?>">Asistencia</a></li><li class="breadcrumb-item active">Registrar</li><?php $__env->stopSection(); ?>
...
<form action="<?php echo e(route('profesor.asistencia.store')); ?>" method="POST" id="asistenciaForm">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4"><label class="form-label fw-semibold">Curso *</label>
            <select name="curso_id" class="form-select" id="curso_id" required>
                ...
                <?php $__currentLoopData = $cursos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($c->id); ?>"><?php echo e($c->nombre); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="col-md-4"><label class="form-label fw-semibold">Fecha *</label><input type="date" name="fecha" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required></div>
    ...
    <div id="tablaAsistencia" class="d-none">
        ...
        <div class="d-flex justify-content-end gap-2 mt-3">
            <a href="<?php echo e(route('profesor.asistencia.index')); ?>" class="btn btn-outline-secondary">Cancelar</a>
...
document.getElementById('cargarEstudiantes').addEventListener('click', function(){
    ...
    fetch('<?php echo e(route('profesor.asistencia.estudiantes')); ?>?curso_id=' + cursoId)
        .then(r => r.json())
        .then(data => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC Lenovo\Downloads\SistemaGestionEscolar (1)\SistemaGestionEscolar\resources\views/profesor/asistencia/create.blade.php ENDPATH**/ ?>